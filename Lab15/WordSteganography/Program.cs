    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (selection > 0 && selection < 3)
            {
                ...
                {
                    Console.WriteLine("Menu:");
                    Console.WriteLine("1. Modifying the number of spaces");
                    Console.WriteLine("2. Kerning modification");
        ...
        {
            //Initialization 
            Document document = new Document("kerning_encrypted_file.docx");
            DocumentBuilder builder = new DocumentBuilder(document);
        ...
        public static void ColorEncryption()
        {
            ...
            document.Save("kerning_encrypted_file.docx");
        }
