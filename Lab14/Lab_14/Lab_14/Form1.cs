    ...
    public partial class Form1 : Form
    {
        ...
        private void openFile_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                Bitmap first256Bitmap = new Bitmap(256, 256);
                ...
                for (int y = 0; y < 256; y++)
                {
                    for (int x = 0; x < 256; x++)
                    {
                        ...
                        first256Bitmap.SetPixel(x, y, originalBitmap.GetPixel(x, y));
                ...
                first256Bitmap.Save("first256pixels2.png", System.Drawing.Imaging.ImageFormat.Png);
        ...
        //    resultBitmap.Save("rowSteganography.png", System.Drawing.Imaging.ImageFormat.Png);
        //}
        ...
        private void stegButton_Click(object sender, EventArgs e)
        {
            ...
            int index = 0; // Индекс текущего символа сообщения
            int direction = 1; // Направление движения по диагонали: 1 - вниз, -1 - вверх
            ...
            for (int i = 0; i < 256 * 256; i++)
            {
                ...
                {
                    redArr[x, y] = redArr[x, y].Substring(0, 7) + text[index];
                    greenArr[x, y] = greenArr[x, y].Substring(0, 7) + text[index + 1];
                    blueArr[x, y] = blueArr[x, y].Substring(0, 7) + text[index + 2];

                    index += 3;
                }

                // Изменение направления движения по диагонали
                ...
                // Прекращение цикла, если достигнут конец сообщения
                if (index >= text.Length)
                {
                    break;
                }
            ...
            stegImage.Image = resultBitmap;
            resultBitmap.Save("diagonalSteganography.png", System.Drawing.Imaging.ImageFormat.Png);
        }
